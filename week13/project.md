# Week 13 — Project (Author + Front-End)

**Theme:** Authoring Excellence • Structured Content (Simulated Fragments)  
...
## Prerequisites
- You completed `week13/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: Page(s) showing the **fragment** reused in ≥3 places.
   - Insert required blocks exactly as specified in `week13/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week13/screenshots/`:
  1. `week13_project_editor_<yourname>.png` — editor view  
  2. `week13_project_published_<yourname>.png` — published page  
  3. `week13_project_pr_<yourname>.png` — Pull Request page  
  4. `week13_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-13-project`

2) Commit
   - Message: `Week 13 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week13] Project Submission`
