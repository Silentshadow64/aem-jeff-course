# Week 01 — Exercise (Author + Front-End)
...
1. **Create About Us**
   - Add Heading, Paragraph, Image; add ALT; set Featured Image.
2. **Taxonomy**
   - Create 3 Tags & 2 Categories; assign to a Post.
3. **Publish**
   - Publish page & post; capture editor + published views.

**Why this matters for AEM:**  
Pages/Blocks ⇢ AEM Pages & Components
Featured Image/ALT ⇢ AEM Asset Metadata
Publish ⇢ Replication (Author → Publish)
...
1. **Explore repo**
   - Locate `week01/` and read files.
2. **Commit & PR**
   - Edit `week01/exercise.md` to add your name; commit, push, open PR; screenshot PR.
...
## 📸 Deliverables
- **Minimum 3 screenshots** in `week01/screenshots/`:
