# Week 11 — Project (Author + Front-End)

**Theme:** Information Architecture • Navigation, Taxonomy, Tags  
...
## Prerequisites
- You completed `week11/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: **Navigation menu** + a **tagged archive** page.
   - Insert required blocks exactly as specified in `week11/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week11/screenshots/`:
  1. `week11_project_editor_<yourname>.png` — editor view  
  2. `week11_project_published_<yourname>.png` — published page  
  3. `week11_project_pr_<yourname>.png` — Pull Request page  
  4. `week11_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-11-project`

2) Commit
   - Message: `Week 11 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week11] Project Submission`
