# Week 08 — Project (Author + Front-End)
...
## Prerequisites
- You completed `week08/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: A page after **a11y fixes** (headings/landmarks/contrast/alt).
   - Insert required blocks exactly as specified in `week08/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week08/screenshots/`:
  1. `week08_project_editor_<yourname>.png` — editor view  
  2. `week08_project_published_<yourname>.png` — published page  
  3. `week08_project_pr_<yourname>.png` — Pull Request page  
  4. `week08_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-08-project`

2) Commit
   - Message: `Week 08 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week08] Project Submission`
