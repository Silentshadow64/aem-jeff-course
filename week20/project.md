# Week 20 — Project (Author + Front-End)

**Theme:** Templates & Policies (Simulated) • Allowed Components  
...
## Prerequisites
- You completed `week20/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: A **template-based** page with **allowed components** per region (simulated).
   - Insert required blocks exactly as specified in `week20/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week20/screenshots/`:
  1. `week20_project_editor_<yourname>.png` — editor view  
  2. `week20_project_published_<yourname>.png` — published page  
  3. `week20_project_pr_<yourname>.png` — Pull Request page  
  4. `week20_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-20-project`

2) Commit
   - Message: `Week 20 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week20] Project Submission`
