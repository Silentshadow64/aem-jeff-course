# Week 12 — Project (Author + Front-End)

**Theme:** Midterm (Creative) • Mini-Site Milestone  
...
## Prerequisites
- You completed `week12/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: **Mini-site** with **3–5 pages** and curated media.
   - Insert required blocks exactly as specified in `week12/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week12/screenshots/`:
  1. `week12_project_editor_<yourname>.png` — editor view  
  2. `week12_project_published_<yourname>.png` — published page  
  3. `week12_project_pr_<yourname>.png` — Pull Request page  
  4. `week12_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-12-project`

2) Commit
   - Message: `Week 12 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week12] Project Submission`
