# Week 23 — Project (Author + Front-End)

**Theme:** Capstone Integration • Assemble Complete Site  
...
## Prerequisites
- You completed `week23/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: Integrated **capstone site** with **a11y/perf evidence**.
   - Insert required blocks exactly as specified in `week23/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week23/screenshots/`:
  1. `week23_project_editor_<yourname>.png` — editor view  
  2. `week23_project_published_<yourname>.png` — published page  
  3. `week23_project_pr_<yourname>.png` — Pull Request page  
  4. `week23_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-23-project`

2) Commit
   - Message: `Week 23 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week23] Project Submission`
