# Week 05 — Project (Author + Front-End)

**Theme:** Front-End • Custom Blocks Overview  
...
## Prerequisites
- You completed `week05/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: A page using **≥2 Reusable Blocks** (Hero, CTA, Image+Text).
   - Insert required blocks exactly as specified in `week05/exercise.md`.
   - Save as **Draft** first.
...
1) Locate and adjust files
   - Open folder: `wp-content/plugins/aem-blocks/` (or your theme’s block folder)
...
- Screenshots in `week05/screenshots/`:
  1. `week05_project_editor_<yourname>.png` — editor view  
  2. `week05_project_published_<yourname>.png` — published page  
  3. `week05_project_pr_<yourname>.png` — Pull Request page  
  4. `week05_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-05-project`

2) Commit
   - Message: `Week 05 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week05] Project Submission`
