# Week 04 — Project (Author + Front-End)
...
## Prerequisites
- You completed `week04/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: A page moving through **Draft → Pending Review → Publish** with **Revisions**.
   - Insert required blocks exactly as specified in `week04/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week04/screenshots/`:
  1. `week04_project_editor_<yourname>.png` — editor view  
  2. `week04_project_published_<yourname>.png` — published page  
  3. `week04_project_pr_<yourname>.png` — Pull Request page  
  4. `week04_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-04-project`

2) Commit
   - Message: `Week 04 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week04] Project Submission`
