# Week 22 — Project (Author + Front-End)

**Theme:** Technical Track Project • Component Library (M2)  
...
## Prerequisites
- You completed `week22/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: **Component library demo** page (2–3 advanced components).
   - Insert required blocks exactly as specified in `week22/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week22/screenshots/`:
  1. `week22_project_editor_<yourname>.png` — editor view  
  2. `week22_project_published_<yourname>.png` — published page  
  3. `week22_project_pr_<yourname>.png` — Pull Request page  
  4. `week22_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-22-project`

2) Commit
   - Message: `Week 22 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week22] Project Submission`
