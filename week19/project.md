# Week 19 — Project (Author + Front-End)

**Theme:** Landing Page Builder • Component Set Integration  
...
## Prerequisites
- You completed `week19/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: A **landing page** assembled from 3–4 components (hero/grid/CTA/testimonial).
   - Insert required blocks exactly as specified in `week19/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week19/screenshots/`:
  1. `week19_project_editor_<yourname>.png` — editor view  
  2. `week19_project_published_<yourname>.png` — published page  
  3. `week19_project_pr_<yourname>.png` — Pull Request page  
  4. `week19_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-19-project`

2) Commit
   - Message: `Week 19 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week19] Project Submission`
