# Week 24 — Project (Author + Front-End)

**Theme:** Capstone Final • Submission and Presentation  
...
## Prerequisites
- You completed `week24/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: **Final PR** and materials (presentation + governance + tags).
   - Insert required blocks exactly as specified in `week24/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week24/screenshots/`:
  1. `week24_project_editor_<yourname>.png` — editor view  
  2. `week24_project_published_<yourname>.png` — published page  
  3. `week24_project_pr_<yourname>.png` — Pull Request page  
  4. `week24_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-24-project`

2) Commit
   - Message: `Week 24 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week24] Project Submission`
