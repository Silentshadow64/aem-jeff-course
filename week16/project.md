# Week 16 — Project (Author + Front-End)

**Theme:** Testing • QA Checklists, Lighthouse, axe  
...
## Prerequisites
- You completed `week16/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: A page post-**QA checklist** with **Lighthouse/axe** improvements.
   - Insert required blocks exactly as specified in `week16/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week16/screenshots/`:
  1. `week16_project_editor_<yourname>.png` — editor view  
  2. `week16_project_published_<yourname>.png` — published page  
  3. `week16_project_pr_<yourname>.png` — Pull Request page  
  4. `week16_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-16-project`

2) Commit
   - Message: `Week 16 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week16] Project Submission`
