# Week 06 — Project (Author + Front-End)

**Theme:** Front-End • Styling (CSS/SCSS) & Asset Organization  
...
## Prerequisites
- You completed `week06/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: A page showing your **scoped SCSS/CSS** and assets structure.
   - Insert required blocks exactly as specified in `week06/exercise.md`.
   - Save as **Draft** first.
...
1) Locate and adjust files
   - Open folder: Your theme/plugin styles (e.g., `style.scss`) + assets folder
...
- Screenshots in `week06/screenshots/`:
  1. `week06_project_editor_<yourname>.png` — editor view  
  2. `week06_project_published_<yourname>.png` — published page  
  3. `week06_project_pr_<yourname>.png` — Pull Request page  
  4. `week06_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-06-project`

2) Commit
   - Message: `Week 06 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week06] Project Submission`
