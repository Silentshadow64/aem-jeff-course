# Week 21 — Project (Author + Front-End)

**Theme:** Creative Track Project • Campaign Microsite (M2)  
...
## Prerequisites
- You completed `week21/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: **Microsite** (home + ≥3 subpages) with consistent design/a11y.
   - Insert required blocks exactly as specified in `week21/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week21/screenshots/`:
  1. `week21_project_editor_<yourname>.png` — editor view  
  2. `week21_project_published_<yourname>.png` — published page  
  3. `week21_project_pr_<yourname>.png` — Pull Request page  
  4. `week21_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-21-project`

2) Commit
   - Message: `Week 21 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week21] Project Submission`
