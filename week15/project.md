# Week 15 — Project (Author + Front-End)

**Theme:** Advanced Blocks • Dynamic Data (Mock JSON/APIs)  
...
## Prerequisites
- You completed `week15/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: A page rendering **mock JSON** via your data-driven block.
   - Insert required blocks exactly as specified in `week15/exercise.md`.
   - Save as **Draft** first.
...
1) Locate and adjust files
   - Open folder: Data-rendering block files + local JSON
...
- Screenshots in `week15/screenshots/`:
  1. `week15_project_editor_<yourname>.png` — editor view  
  2. `week15_project_published_<yourname>.png` — published page  
  3. `week15_project_pr_<yourname>.png` — Pull Request page  
  4. `week15_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-15-project`

2) Commit
   - Message: `Week 15 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week15] Project Submission`
