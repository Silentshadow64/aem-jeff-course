# Week 02 — Project (Author + Front-End)
...
## Prerequisites
- You completed `week02/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: **Home**, **Services**, **Contact** pages with required blocks and links.
   - Insert required blocks exactly as specified in `week02/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week02/screenshots/`:
  1. `week02_project_editor_<yourname>.png` — editor view  
  2. `week02_project_published_<yourname>.png` — published page  
  3. `week02_project_pr_<yourname>.png` — Pull Request page  
  4. `week02_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-02-project`

2) Commit
   - Message: `Week 02 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week02] Project Submission`
