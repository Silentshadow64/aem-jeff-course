# Week 17 — Project (Author + Front-End)

**Theme:** Git Mastery • Branching, PR Reviews, Conflict Resolution  
...
## Prerequisites
- You completed `week17/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: Repo showing **2 feature branches**, **PR merges**, and a **resolved conflict**.
   - Insert required blocks exactly as specified in `week17/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week17/screenshots/`:
  1. `week17_project_editor_<yourname>.png` — editor view  
  2. `week17_project_published_<yourname>.png` — published page  
  3. `week17_project_pr_<yourname>.png` — Pull Request page  
  4. `week17_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-17-project`

2) Commit
   - Message: `Week 17 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week17] Project Submission`
