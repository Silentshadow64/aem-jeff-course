# Week 07 — Project (Author + Front-End)

**Theme:** Front-End • Block Controls, Inspector, Attributes  
...
## Prerequisites
- You completed `week07/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: Your custom block with **Inspector Controls + Attributes** integrated.
   - Insert required blocks exactly as specified in `week07/exercise.md`.
   - Save as **Draft** first.
...
1) Locate and adjust files
   - Open folder: Your block files: `index.js`, `edit.js`, `save.js`, `style.scss`
...
- Screenshots in `week07/screenshots/`:
  1. `week07_project_editor_<yourname>.png` — editor view  
  2. `week07_project_published_<yourname>.png` — published page  
  3. `week07_project_pr_<yourname>.png` — Pull Request page  
  4. `week07_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-07-project`

2) Commit
   - Message: `Week 07 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week07] Project Submission`
