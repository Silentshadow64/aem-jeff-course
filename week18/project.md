# Week 18 — Project (Author + Front-End)
...
## Prerequisites
- You completed `week18/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: Rendered **Authoring Guide** and **Developer README** with cross-links.
   - Insert required blocks exactly as specified in `week18/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week18/screenshots/`:
  1. `week18_project_editor_<yourname>.png` — editor view  
  2. `week18_project_published_<yourname>.png` — published page  
  3. `week18_project_pr_<yourname>.png` — Pull Request page  
  4. `week18_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-18-project`

2) Commit
   - Message: `Week 18 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week18] Project Submission`
