# Week 03 — Project (Author + Front-End)

**Theme:** Content Modeling • Blocks, Patterns, Templates  
...
## Prerequisites
- You completed `week03/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: Pages using your **2 Patterns** and shared **Template**.
   - Insert required blocks exactly as specified in `week03/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week03/screenshots/`:
  1. `week03_project_editor_<yourname>.png` — editor view  
  2. `week03_project_published_<yourname>.png` — published page  
  3. `week03_project_pr_<yourname>.png` — Pull Request page  
  4. `week03_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-03-project`

2) Commit
   - Message: `Week 03 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week03] Project Submission`
