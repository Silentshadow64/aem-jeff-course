# Week 14 — Project (Author + Front-End)

**Theme:** Localization • Multilingual Content (Simulated)  
...
## Prerequisites
- You completed `week14/exercise.md` on a feature branch.
...
1) Build the target page(s)
   - Target: **EN/ES** variants with **localized** labels and **ALT** text.
   - Insert required blocks exactly as specified in `week14/exercise.md`.
   - Save as **Draft** first.
...
- Screenshots in `week14/screenshots/`:
  1. `week14_project_editor_<yourname>.png` — editor view  
  2. `week14_project_published_<yourname>.png` — published page  
  3. `week14_project_pr_<yourname>.png` — Pull Request page  
  4. `week14_project_structure_<yourname>.png` — file/folder view showing edited files
...
1) Branch
   - Name: `<yourname>/week-14-project`

2) Commit
   - Message: `Week 14 Project: <short description>`

3) Push and Pull Request
   - Title: `[<YourName>][Week14] Project Submission`
